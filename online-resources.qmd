...
description: useful bioinformatics tools and resources for you
---
...
::: {layout-ncol=2}
[![](images/nf-core-logo-square.svg){.class width=50%}](https://nf-co.re/)

<br>
[Nf-core](https://nf-co.re/) - Portable, documented and easy to use workflows based on nextflow. 

<br><br>
[![](images/Git_square.png){.class width=50%}](https://git-scm.com/)
...
::: {layout-ncol=2}
[![](images/swc-hex-logo.svg){.class width=50%}](https://software-carpentry.org/)
...
<br><br>
[![](images/terminal.png){.class width=50%}](https://swcarpentry.github.io/shell-novice/)
...
<br><br>
[![](images/elixir.png){.class width=50%}](https://elixir-europe.org/)
...
<br><br>
[![](images/Code_refinery.png){.class width=50%}](https://coderefinery.org/)
...
::: {layout-ncol=2}
[![](images/SLUBI_logo.png){.class width=50%}](https://www.slubi.se)
...
<br><br><br>
[![](images/naiss_logo_black.png){.class width=70%}](https://www.naiss.se/)
...
<br><br>
[![](images/uppmax.png){.class width=90%}](https://www.uppmax.uu.se/)
...
[![](images/microsoft-azure.jpg){.class width=90%}](https://azure.microsoft.com/de-de/)
...
::: {layout-ncol=2}
[![](images/slu_logo_cmyk.jpg){.class width=60%}](https://www.slu.se/en/Collaborative-Centres-and-Projects/centreforstatistics/)
...
[![](images/slu_logo_cmyk.jpg){.class width=60%}](https://www.slu.se/en/subweb/library/publish-and-analyse/archiving-and-publishing-research-data/)
...
<br>
[![](images/UPSC.png){.class width=60%}](https://www.upsc.se/platforms/upsc-bioinformatics-facility.html)
...
::: {layout-ncol=2}
<br><br>
[![](images/NGI-logo.svg){.class width=80%}](https://ngisweden.scilifelab.se/)
...
<br><br>
[![](images/SciLifeLab_Logotype_Green_POS.svg){.class width=80%}](https://www.medsci.uu.se/snpseq_technology_platfom/)
...
<br><br>
[![](images/SciLifeLab_Logotype_Green_POS.svg){.class width=80%}](https://www.ugc.igp.uu.se/our-services/sequencing/)
